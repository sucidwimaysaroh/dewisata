...
<section id="hero">
  <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
    <h1>Selamat Datang di Dewisata</h1>
    <h2>Temukan Surga Dunia Tersembunyi Bersama Kami</h2>
    ...
    <div class="container" data-aos="fade-up">
      <div class="row about-container">
        ...
        <div class="col-lg-6 content order-lg-1 order-2">
          <h2 class="title">Beberapa Hal Tentang Kami</h2>
          <p>
            Dewisata adalah sebuah website yang dapat anda gunakan untuk mempromosikan
            tempat wisata di daerah anda dengan anda sebagai pengelola di dewisata. </p>
          <p>Melalui Dewisata temukan tempat tersembunyi dengan anda sebagai wisatawan
          </p>
  ...
  <section id="services">
    <div class="container" data-aos="fade-up">
      <div class="section-header">
        ...
        <p class="section-description">Berbagai macam fitur yang telah kami sediakan untuk ada gunakan</p>
      </div>
      <div class="row">
        <div class="col-lg-4 col-md-6" data-aos="zoom-in">
          <div class="box">
            <div class="icon"><a href=""><i class="fa fa-desktop"></i></a></div>
            <h4 class="title"><a href="">TEMUKAN DAN PROMOSIKAN</a></h4>
            <p class="description">Temukan wisata tersembunyi atau promosikan tempat wisatamu</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6" data-aos="zoom-in">
          <div class="box">
            <div class="icon"><a href=""><i class="fa fa-bar-chart"></i></a></div>
            <h4 class="title"><a href="">Dalam Pengembangan</a></h4>
            <p class="description">Masih dikembangkan Mohon Doanyaa</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6" data-aos="zoom-in">
          <div class="box">
            <div class="icon"><a href=""><i class="fa fa-paper-plane"></i></a></div>
            <h4 class="title"><a href="">PESAN TIKET</a></h4>
            <p class="description">Pesan tiket untuk menikmati tujuan wisatamu dengan mudah</p>
          </div>
        </div>
      ...
      <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
          ...
          <div class="portfolio-info">
            ...
            <a href="{{asset('/front/')}}/portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6">
          <div class="member" data-aos="fade-up" data-aos-delay="100">
            <div class="pic"><img src="{{asset('/front/')}}/assets/img/team-1.jpg" alt=""></div>
            <h4>Walter White</h4>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="member" data-aos="fade-up" data-aos-delay="200">
            <div class="pic"><img src="{{asset('/front/')}}/assets/img/team-2.jpg" alt=""></div>
            <h4>Sarah Jhinson</h4>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="member" data-aos="fade-up" data-aos-delay="300">
            <div class="pic"><img src="{{asset('/front/')}}/assets/img/team-3.jpg" alt=""></div>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="member" data-aos="fade-up" data-aos-delay="400">
            <div class="pic"><img src="{{asset('/front/')}}/assets/img/team-4.jpg" alt=""></div>
            <h4>Amanda Jepson</h4>
