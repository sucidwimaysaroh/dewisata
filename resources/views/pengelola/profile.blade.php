							...
							<div class="profile-left">
								...
								<div class="profile-header">
									...
									<div class="profile-main">
										<img src="{{$pengelola->getAvatar()}}" class="img-circle" alt="Avatar" width="100px">
										<h3 class="name">{{$pengelola->nama_depan}}</h3>
								...
								<div class="profile-detail">
									<div class="profile-info">
										...
										<ul class="list-unstyled list-justify">
											<li>NIK <span>{{$pengelola->nik}}</span></li>
											<li>Tanggal lahir <span>{{$pengelola->tanggal_lahir}}</span></li>
											<li>Jenis Kelamin <span>{{$pengelola->jenis_kelamin}}</span></li>
											<li>Alamat <span>{{$pengelola->alamat}}</span></li>
