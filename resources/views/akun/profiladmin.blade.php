							...
							<div class="profile-left">
								...
								<div class="profile-header">
									...
									<div class="profile-main">
										<img src="{{auth()->user()->getAvatar()}}" class="img-circle" alt="Avatar" width="100px">
								...
								<div class="profile-detail">
									...
									<div class="text-center"><a href="/akun/{{auth()->user()->id}}/edit" class="btn btn-primary">Edit Profile</a></div>
								</div>
								<!-- END PROFILE DETAIL -->
							</div>
							<!-- END LEFT COLUMN -->
