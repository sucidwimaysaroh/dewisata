				...
				<div class="container-fluid">
					<div class="panel panel-profile">
							...
							<div class="profile-left">
								...
								<div class="profile-header">
									...
									<div class="profile-main">
										<img src="{{auth()->user()->wisatawan->getAvatar()}}" class="img-circle" alt="Avatar" width="100px">
										<h3 class="name">{{auth()->user()->wisatawan->nama_depan}}</h3>
                      ...
                      <li>Email <span>{{auth()->user()->wisatawan->User->email}}</span></li>
									...
									<div class="text-center"><a href="/wisatawan/{{auth()->user()->wisatawan->id}}/edit" class="btn btn-primary">Edit Profile</a></div>
								</div>
								<!-- END PROFILE DETAIL -->
							</div>
							<!-- END LEFT COLUMN -->
